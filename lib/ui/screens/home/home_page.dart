...
enum Province {
  ...
  String get imagePath {
    // Handle special case for Phnom Penh
    if (this == Province.phnomPenh) {
      return 'assets/provinces/phnomPenh.jpg';
    }
    return 'assets/provinces/$name.jpg';
  }
    ...
    return Scaffold(
      ...
      floatingActionButton: Container(
        ...
        child: FloatingActionButton(
          ...
          child: Image.asset(
            'assets/images/Chatbot Chat Message.jpg',
            width: 40,
            height: 40,
          ),
        ),
